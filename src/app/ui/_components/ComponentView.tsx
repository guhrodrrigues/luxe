...
export function ComponentView({
  ...
  return (
    <div
      className={cn(
        "flex min-h-[250px] items-center justify-center overflow-hidden overflow-x-auto border-neutral-800/50 bg-neutral-950 p-8 shadow max-sm:-mx-6 max-sm:border-y sm:rounded-xl sm:border",
