export function BadgeAnimatedBorder() {
  return (
    <button className="group relative grid overflow-hidden rounded-full px-3 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
      <span>
      ...
      <span className="z-10 text-neutral-400 text-xs font-medium">Badge</span>
    </button>
  );
}
