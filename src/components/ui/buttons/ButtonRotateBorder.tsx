export function ButtonRotateBorder() {
  return (
    <button className="relative inline-flex overflow-hidden rounded-xl p-px">
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-neutral-950 px-4 py-2 text-sm font-medium text-gray-50 backdrop-blur-3xl">
        Button
      </span>
    </button>
  );
