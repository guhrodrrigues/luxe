...
<CommandBlock 
	npmCommand="npx @luxeui/ui add input" 
	pnpmCommand="pnpm dlx @luxeui/ui add input" 
	yarnCommand="npx @luxeui/ui add input" 
	bunCommand="bunx --bun @luxeui/ui add input" 
/>
...
<CommandBlock 
	npmCommand="npm install motion clsx tailwind-merge" 
