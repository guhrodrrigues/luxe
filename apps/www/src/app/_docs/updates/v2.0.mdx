...
<div className="w-full h-[400px] rounded-xl border border-border dark:border-neutral-900 mt-6 mb-8" />

As shown in the video above, it's now much simpler to apply styles. Previously, using <CodeHighlight>ButtonAnimatedBorder</CodeHighlight> required importing a separate component. Now, you can achieve the same effect by simply using the <CodeHighlight>Button variant="animated-border"</CodeHighlight>.

The <CodeHighlight>Button</CodeHighlight> now supports nine variants: <CodeHighlight>shine</CodeHighlight>, <CodeHighlight>animated-border</CodeHighlight>, <CodeHighlight>rotate-border</CodeHighlight>, <CodeHighlight>magnetic</CodeHighlight>, <CodeHighlight>glitch-brightness</CodeHighlight>, <CodeHighlight>default</CodeHighlight>, <CodeHighlight>outline</CodeHighlight>, <CodeHighlight>success</CodeHighlight>, and <CodeHighlight>destructive</CodeHighlight>.
...
To be honest, this feature is one of my favorites ones. It's a game changer for customizing components.
...
<div className="relative w-full h-[400px] rounded-xl border border-transparent dark:border-neutral-900 mt-6 mb-8 overflow-hidden">

<video src="/videos/v2.0/new-components.mp4" className="absolute inset-0 size-full object-cover rounded-[inherit]" autoPlay muted loop playsInline />
...
<Image src="/images/v2.0/sidebar.png" alt="Old/New components sidebar" width={1920} height={1000} />
...
<div className="w-full h-[400px] rounded-xl border border-border dark:border-neutral-900 my-8" />

You can learn more in the <Link href="/ui/cli">CLI docs</Link>. Get started by running <CodeHighlight>npx @luxeui/ui init</CodeHighlight>, then use <CodeHighlight>npx @luxeui/ui add</CodeHighlight> to add components to your project.
...
This CLI was built in collaboration with <Link href="https://x.com/lucasaugustsof" isExternal>Lucas Augusto</Link>, a Design Systems Specialist and Creator of <Link href="https://github.com/lucasaugustsof/hynix" isExternal>Hynix</Link>. His expertise in building CLI was fundamental, making his contribution essential to Luxe's future.
