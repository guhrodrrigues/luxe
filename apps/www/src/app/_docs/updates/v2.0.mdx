...
<video src="/videos/v2.0/new-components.mp4" className="absolute inset-0 size-full object-cover rounded-[inherit]" poster="/images/v2.0/new-components.jpg" autoPlay muted loop playsInline />
