...
<CommandBlock 
	npmCommand="npx luxe add dropdown-menu" 
	pnpmCommand="pnpm dlx luxe add dropdown-menu" 
	yarnCommand="npx luxe add dropdown-menu" 
	bunCommand="bunx --bun luxe add dropdown-menu" 
/>
