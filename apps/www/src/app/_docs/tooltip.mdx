...
<CommandBlock 
	npmCommand="npm install @radix-ui/react-tooltip clsx tailwind-merge" 
	pnpmCommand="pnpm add @radix-ui/react-tooltip clsx tailwind-merge" 
	yarnCommand="yarn add @radix-ui/react-tooltip clsx tailwind-merge" 
	bunCommand="bun add @radix-ui/react-tooltip clsx tailwind-merge" 
/>
