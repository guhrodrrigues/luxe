...
<CommandBlock 
	npmCommand="npx luxe add multi-step-modal" 
	pnpmCommand="pnpm dlx luxe add multi-step-modal" 
	yarnCommand="npx luxe add multi-step-modal" 
	bunCommand="bunx --bun luxe add multi-step-modal" 
/>
