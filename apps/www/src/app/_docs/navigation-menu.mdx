...
<CommandBlock
	npmCommand="npx luxe add navigation-menu"
	pnpmCommand="pnpm dlx luxe add navigation-menu"
	yarnCommand="npx luxe add navigation-menu"
	bunCommand="bunx --bun luxe add navigation-menu"
/>
