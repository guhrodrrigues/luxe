...
<CommandBlock 
	npmCommand="npm install @radix-ui/react-dialog" 
	pnpmCommand="pnpm add @radix-ui/react-dialog" 
	yarnCommand="yarn add @radix-ui/react-dialog" 
	bunCommand="bun add @radix-ui/react-dialog" 
/>
