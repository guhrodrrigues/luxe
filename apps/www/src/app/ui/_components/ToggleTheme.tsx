  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-1 focus-visible:ring-neutral-300/80 dark:focus-visible:ring-neutral-800 bg-background ease-linear duration-150",
        "border border-border/60 dark:border-border/50 dark:bg-main-foreground/10 dark:hover:bg-main-foreground/20 dark:hover:border-white/10",
